...
//				vo.setJoinDate(joinDate);
	...
	public MemberVO findMember(String id) {
		...
		//조회한 회원정보를 저장할 MemberVO클래스 타입의 변수 선언
		MemberVO memInfo = null;
		
		try {
			//커넥션풀로부터 커넥션 얻기
			con = ds.getConnection();
			//SQL문 만들고 SQL문을 실행할 PreparedStatement객체 얻기
	...
	//매개변수로 전달 받은 MemberVO객체를 이용하여 회원정보 수정 UPDATE
	public void modMember(MemberVO memberVO) {
		//수정할 정보를 MemberVO에서 꺼내오기
	...
	//매개변수로 전달된 삭제할 id를 이용해 t_member테이블에 저장된 회원삭제
