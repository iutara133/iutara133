	...
	private void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (action==null){	
				...
				pw.print("<script>" + "  alert('글을 추가했습니다.');" + " location.href='" + request.getContextPath()
				...
				PrintWriter pw = response.getWriter();
				pw.print("<script>" + "  alert('글을삭제했습니다.');" + " location.href='" + request.getContextPath()
						+ "/board/listArticles.do';" + "</script>");
				return;
				...
				PrintWriter pw = response.getWriter();
				pw.print("<script>" + "  alert('답변글추가성공.');" + " location.href='" + request.getContextPath()
						+ "/board/viewArticle.do?articleNO="+articleNO+"';" + "</script>");
				return;
			}
